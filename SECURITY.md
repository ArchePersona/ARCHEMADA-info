...
- any known conditions required to trigger the issue.

## Sensitive Information

Do not include passwords, API keys, access tokens, private customer information, private repository contents, or other credentials in a vulnerability report unless a secure exchange method has been established.
